...
void mpp_meas_cycl_init(typeMPPStruct* mpp_ptr)
{
	...
	//
	cyclo_add_step(&mpp_ptr->meas_cyclo, CYCLO_DO_NOTHING, (void*)mpp_ptr, 0, 0 + channel_delay, data);
	cyclo_add_step(&mpp_ptr->meas_cyclo, mpp_meas_cycl_struct_request, (void*)mpp_ptr, 0, 150, data);
	cyclo_add_step(&mpp_ptr->meas_cyclo, mpp_meas_cycl_struct_get, (void*)mpp_ptr, 0, 0, data);
	cyclo_add_step(&mpp_ptr->meas_cyclo, mpp_meas_cycl_arch_offset_get, (void*)mpp_ptr, 0, 0, data);
	cyclo_add_step(&mpp_ptr->meas_cyclo, mpp_meas_cycl_forced_start, (void*)mpp_ptr, 0, 100, data);
}
